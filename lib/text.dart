...
//     // Create a ParagraphBuilder to build the text
...
//     // Create a PictureRecorder to record the text as an image
...
//     ui.Image textImage = await picture.toImage(
//       paragraph.width.ceil(),
//       paragraph.height.ceil(),
//     );

//     // Convert the ui.Image to a byte array
//     ByteData? byteData =
...
//   //   // Text to print in Spanish
//   //   String spanishText = "¡Hola mundo! करण्यासाठी";

//   //   // Encode the text in UTF-8
//   //   List<int> utf8EncodedText = utf8.encode(spanishText);

//   //   // Convert the List<int> to Uint8List
//   //   Uint8List utf8EncodedTextUint8List = Uint8List.fromList(utf8EncodedText);

//   //   // Print the text using textEncoded method with UTF-8 encoding
//   //   bytes += generator.textEncoded(utf8EncodedTextUint8List);
...
//   //   bytes += generator.text('इंग्रजी आणि मराठी मध्ये स्विच करण्यासाठी');
